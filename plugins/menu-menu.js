...
let str = `
*ミ👑 𝙷𝙾𝙻𝙰 ✨${name}✨, 𝙰𝚀𝚄𝙸 𝙴𝚂𝚃𝙰 𝙴𝙻 𝙼𝙴𝙽𝚄 𝙲𝙾𝙼𝙿𝙻𝙴𝚃𝙾 𝙳𝙴 THE-DED-BOT 👑彡*
...
° ඬ⃟⚙️ _${usedPrefix}togifaud *<responde a un video>*_
° ඬ⃟⚙️ _${usedPrefix}toimg *<responde a un sticker>*_
° ඬ⃟⚙️ _${usedPrefix}tomp3 *<responde a un video / nota de voz>*_
° ඬ⃟⚙️ _${usedPrefix}toptt *<responde a un video / audio>*_
° ඬ⃟⚙️ _${usedPrefix}tovideo *<responde a un sticker>*_
° ඬ⃟⚙️ _${usedPrefix}tourl *<responde a un video / imagen / audio>*_
° ඬ⃟⚙️ _${usedPrefix}tts es *<texto>*_
...
° ඬ⃟👑 _${usedPrefix}listprem_
`.trim()
conn.sendHydrated2(m.chat, str, wm, pp, 'https://www.paypal.me/yandervillarevia670', '𝙿𝙰𝚈𝙿𝙰𝙻', 'https://github.com/Theyanderbot/THE-DED-BOT.', '𝙶𝙸𝚃𝙷𝚄𝙱', [
['😘 𝙳𝙾𝙽𝙰𝚁 😘', '/donasi'],
['👑 𝙾𝚆𝙽𝙴𝚁 👑', '/owner'],
['🔥 𝙸𝙽𝙵𝙾𝙱𝙾𝚃 🔥', '/infobot']
], m,)
